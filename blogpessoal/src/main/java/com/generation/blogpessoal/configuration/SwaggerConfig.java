...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("com.generation.blogpessoal.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/conteudoGeneration/blog-pessoal")
			.contact(contact())
			.build();
	}

	private static Contact contact() {
		return new Contact("Conteúdo Generation", 
			"https://github.com/conteudoGeneration", 
			"conteudo.generation@gmail.com");
	}
